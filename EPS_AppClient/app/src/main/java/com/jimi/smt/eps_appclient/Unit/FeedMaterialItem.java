...
public class FeedMaterialItem {
    ...
    public FeedMaterialItem(String orgLineSeat, String orgMaterial, String scanLineSeat, String scanMaterial, String result, String remark) {
