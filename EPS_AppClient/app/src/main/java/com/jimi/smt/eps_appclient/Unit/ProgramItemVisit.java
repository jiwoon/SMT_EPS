...
public class ProgramItemVisit {
    ...
    //发料结果
    private int store_issue_result;
    //发料时间
    private Timestamp store_issue_time;
    //上料结果
    private int feed_result;
    //上料时间
    ...
    //首次全检结果
    private int first_check_all_result;
    //首次全检时间
    private Timestamp first_check_all_time;
    //全检结果
    private int check_all_result;
    //全检时间
    ...
    public int getStore_issue_result() {
        return store_issue_result;
    }

    public void setStore_issue_result(int store_issue_result) {
    ...
    public int getFeed_result() {
        return feed_result;
    }

    public void setFeed_result(int feed_result) {
    ...
    public void setChange_result(int change_result) {
    ...
    public int getCheck_all_result() {
        return check_all_result;
    }

    public void setCheck_all_result(int check_all_result) {
    ...
    public int getFirst_check_all_result() {
        return first_check_all_result;
    }

    public void setFirst_check_all_result(int first_check_all_result) {
